...
void main() async{
  ...
  // //Add new student
  // Student newStudent = Student(id:0, name:'Gia Binh', phone:'09123456');
  // await dbHelper.createStudent(newStudent);
  // print('Đã thêm sinh viên mới');
  //
  // //Display all student
  ...
  //
  // //Update student
  // Student updateStudent = students.last;
  // updateStudent.name = 'Truong Tung';
  // updateStudent.phone = '333333333';
  // await dbHelper.updateStudent(updateStudent);
  // print('Đã cập nhật thông tin sinh viên');
  //
  // //Delete student
